...
export class HappningNowComponent {
  ...
  events = [
    ...
    {
      title: 'Indreni Dohori Sanjh witk Krishan Kandel',
      description: 'Indreni Dohori Sanjh witk Krishan Kandel and other many singers ..\n' +
        '\n\ ',

      address: 'WYNDHAM GARDEN\n\ 10800 VANDOR LN\nMANASSAS, VA 20109',
...

    {
      ...
      description: 'Holiday Walk of Lights is back this year and brighter than ever! Experience the magic of the holiday season as you walk down a path of unique, hand-crafted light displays at Neabsco Regional Park. Bring family and friends and be prepared to be in awe of the dazzling lights that surround us! .',
